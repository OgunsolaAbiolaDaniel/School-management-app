...
function Notification() {
  ...
  return (
    <div className="flex flex-col w-fit absolute z-20 right-3 left-3 shadow-lg sm:right-5 sm:left-5 bsm:w-[330px] bsm:left-[40%] md:left-[55%] lg:left-[65%] xl:left-[70%] 2xl:left-[75%] rounded-lg p-2 px-3 sm:w-fit">
